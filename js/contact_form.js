...
{
    mesajSalut = "buna ziua ";       
} 
else
{
    mesajSalut = "buna seara ";      
}
...
form.addEventListener('submit', function(event)
{
    ...
    if(nume.length<2)
    {
        feedback.textContent="nume scurt";
        feedback.style.color="red";
    }

    else if(!email.includes('@'))
    {
        feedback.textContent="email trebuie sa contina @";
        feedback.style.color="red";
    }
    ...
    {
        feedback.textContent=" multumesc de mesaj, " + nume;
